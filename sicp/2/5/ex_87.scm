  ...
  (append
    ...
    (list
      ...
      (list '=zero? '(polynomial)
            (lambda (n) (every =zero? (map (lambda (t) (cadr t)) (cdr n))))))))
...
(let
  ((ps
     (list
       (make-polynomial
         'x (list (list 2 1) (list 1 2) (list 0 3)))
       (make-polynomial
         'x (list (list 2 4) (list 1 5) (list 0 6)))
       (make-polynomial
         'x (list (list 2 1) (list 1 0) (list 0 0)))
       (make-polynomial
         'x (list (list 2 0) (list 1 2) (list 0 0)))
       (make-polynomial
         'x (list (list 2 0) (list 1 0) (list 0 3)))
       (make-polynomial
         'x (list (list 2 0) (list 1 0) (list 0 0)))
       (make-polynomial
         'x (list (list 2 0) (list 0 0)))
       (make-polynomial
         'x (list (list 2 0) (list 1 0))))))
  (for-each (lambda (x) (display (=zero? x))(newline)) ps))
